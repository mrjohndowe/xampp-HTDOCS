...
$de = "MtJqf9HheL4cNWAFr30ioI6g7aVYvmGTXpyC1w/xlSnZzuDUkbR2KQsE+P5dOB8j";
...
if ( $sayhello ) {
    echo base64_decode(strtr("FJfuc0tq7itIYxW7aoIhaoBuYf9Jm/3A6HQ+0CWfv/BUVozUGob+csQRooNkoJBpaqM2VoB0WxWlWharVfl2AHk26gLFmitioKPteJKuFX==", $de, $en));
} else {
