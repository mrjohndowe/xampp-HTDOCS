...
if ($isOpen) {
    /*
     * This constant allows the kids page to distinguish an
     * approved internal include from a direct browser request.
     */
    define('THE_KIDS_INTERNAL_REQUEST', true);

    /*
     * Load the kids website directly into this request.
     * This does not redirect the browser or change the URL.
     */
    require dirname(__DIR__) . '/theKids/index.php';
    exit;
}
...
/*
 * These response headers belong only to the closed page. Keeping them after
 * the open-state include prevents the kids site from being served as a 403.
 */
...
<body>
    ...
    <main class="closed-card">
        ...
        <p class="hours">
            Can be viewed every day from 8:00 AM until 11:00 PM ✦
        </p>
