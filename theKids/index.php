...
$backgroundTrack = 'assets/audio/background.mp3';
$hasBackgroundTrack = is_file(__DIR__ . '/' . $backgroundTrack);
?>
<!doctype html>
<html lang="en">
<head>
...
<link rel="stylesheet" href="assets/css/style.css?v=20260916-4">
...
<body>
  ...
  <audio id="backgroundMusic" hidden loop preload="none" <?= $hasBackgroundTrack ? 'src="' . htmlspecialchars($backgroundTrack, ENT_QUOTES, 'UTF-8') . '"' : '' ?>></audio>
...
<script src="assets/js/script.js?v=20260916-4"></script>
</body></html>
