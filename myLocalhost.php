...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            $path = fm_clean_path($path);
            $root_url = "
                <a href='?p='><i style='font-size:35px;' class='fa fa-home' aria-hidden='true' title='" . FM_ROOT_PATH . "'></i></a>";
           $root_url .= '
                <a target="_blank" href="/.specialLinks"><i style="text-shadow:8px 1px 10px silver;font-size: 35px;color:red;" class="fa fa-heartbeat" aria-hidden="true" title="The Big List of Porno"></i></a>
            ';
