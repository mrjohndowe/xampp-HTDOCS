...
//Application Title
define('APP_TITLE', $_SERVER['HTTP_HOST']);
...
$conf = new FM_Config();
define('FMDark', $conf->data['theme']);

$darkTheme = $use_highlightjs == true && FMDark == "dark" ? 'ir-black' : 'vs';

// highlight.js style
// for dark theme use 'ir-black'
$highlightjs_style = $darkTheme;
...
$default_timezone = 'America/Denver'; // INDIA
...
$favicon_path = '/.global/assets/favicon.svg';

// Files and folders to excluded from listing
// e.g. array('myfile.html', 'personal-folder', '*.php', ...)
$exclude_items = array('myLocalhost.php','.phpLiteAdmin.OLD','.htaccess');
                        ...
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            ...
                            <div style="display: flex; justify-content: center; align-items: center; padding: 10px;">
                                <a href="https://readmecodegen.com" target="_blank" rel="noopener noreferrer" style="display: inline-block; width: fit-content;">
                                    <img src="https://readmecode-pdf.onrender.com/api/badge/user_mu51dafs_8l05ug?style=shield3&textColor=%23ffffff&bg=%23ef4444" alt="Visitor Badge" style="display: block; max-width: 100%; height: auto;" />
                                </a>
                            </div>
                    </div>
                </div>
...
/**
 * Get dashboard functions for logged-in users
 */
function getDashboardFunctions() {
    return '';
}
...
function fm_show_nav_path($path)
{
    ...
    <nav class="navbar navbar-expand-lg <?php echo $getTheme; ?> mb-4 main-nav <?php echo $isStickyNavBar ?>">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <?php
            $path = fm_clean_path($path);
            $root_url = '<a href="dashboard.php"><i style="font-size:35px;" class="fa fa-home" aria-hidden="true" title="Dashboard"></i></a>';
           $root_url .= '<a href="?p="><i style="font-size:35px;" class="fa fa-folder" aria-hidden="true" title="' . FM_ROOT_PATH . '"></i></a>';
            ...
            <div class="col-xs-6 col-sm-7 text-right">
                <ul class="navbar-nav mr-auto float-right <?php echo fm_get_theme();  ?>">
                    ...
                    <?php if (FM_USE_AUTH): ?>
                	<li class="nav-item">
                        <a title="<?php echo lng('PhpMyAdmin') ?>" class="nav-link" href="/phpmyadmin" target="_blank"><i class="fa fa-user-circle" aria-hidden="true"></i> <?php echo lng('PhpMyAdmin') ?></a>
                	</li>

                	<li class="nav-item">
                		<a title="<?php echo lng('Logout') ?>" class="nav-link" href="?logout=1"><i class="fa fa-sign-out" aria-hidden="true"></i> <?php echo lng('Logout') ?></a>
                	</li>
                    <?php else: ?>
                        <?php if (!FM_READONLY): ?>
                            <li class="nav-item">
...
<head>
    ...
    if (FM_THEME == "dark"): ?>
        <style>
            ...
            .list-group .list-group-item { background: #000; }
...
<?php endif; ?>
<div id="snackbar"></div>
<script src="https://readmecodegen.com/view-tracker.js" data-user="user_mu51dafs_8l05ug"></script>
</body>
</html>
<?php
}
