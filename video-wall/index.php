...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        $settings = ['folders'=>$valid,'ffmpegPath'=>$ffmpegPath,'autoNext'=>!empty($settings['autoNext']),'startMuted'=>!empty($settings['startMuted']),'debugEnabled'=>!empty($settings['debugEnabled'])];
