...
<!doctype html>
    <html lang="en">
        ...
        <body>
                ...
                <main class="admin-page">
                    ...
                    <section class="admin-card playback-preferences">
                        ...
                        <div class="playback-settings" id="playbackPreferences">
                            ...
                            <label><input type="checkbox" id="debugEnabledPreference" <?php echo !empty($settings['debugEnabled']) ? 'checked' : '' ?>> Debug Enabled</label>
                        </div>
                        <p class="preference-save-status" id="preferenceSaveStatus" role="status">Changes save automatically.</p>
                        <label class="ffmpeg-field"><span>FFmpeg executable <small>(optional)</small></span><input id="ffmpegPathPreference" value="<?php echo htmlspecialchars((string)($settings['ffmpegPath'] ?? '')) ?>" placeholder="Full path to ffmpeg.exe" autocomplete="off" spellcheck="false"></label>
            ...
            <script src="assets/js/player-preferences.js?v=2"></script>
        </body>
    </html>
