(() => { "use strict";
  ...
  button.addEventListener("click", async () => {
    card.classList.add("is-loading"); button.disabled = true; button.textContent = "Analyzing…"; status.textContent = "Extracting temporary frames and asking your local Ollama model…"; results.hidden = true;
    try {
    ...
    finally { card.classList.remove("is-loading"); button.disabled = false; button.textContent = "✦ Analyze with Ollama"; }
  });
})();
