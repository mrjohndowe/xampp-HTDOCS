(() => {
  ...
  const preferences = Object.assign(
    { autoNext: true, startMuted: false, debugEnabled: false },
  ...
  const debugEnabled = document.querySelector("#debugEnabledSetting");
  ...
  if(debugEnabled){
    debugEnabled.checked = preferences.debugEnabled;
    debugEnabled.addEventListener("change", () => {
      preferences.debugEnabled = debugEnabled.checked;
      save();
    });
  }
